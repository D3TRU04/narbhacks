    ...
    <div className="min-h-screen flex flex-col items-center bg-muted px-4 py-8">
      <div className="w-full max-w-lg bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 mb-6">
        ...
        <div className="mb-4">
          ...
          <input className="w-full p-3 rounded border mb-2" placeholder="Username" />
          <input className="w-full p-3 rounded border mb-2" placeholder="Email" type="email" />
          <input className="w-full p-3 rounded border mb-2" placeholder="Profile Photo URL" type="url" />
